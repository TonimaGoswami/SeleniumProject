...
public class Homeworkday3 {
	private static final String Smith = null;
	...
	public void testSearchMyNameFirstRow() {
		...
		WebElement empNameField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#empsearch_employee_name_empName.inputFormatHint")));
		empNameField.clear();
		empNameField.sendKeys(expected + Keys.ESCAPE);
		
		driver.findElement(By.id("searchBtn")).click();
		
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("input#empsearch_employee_name_empName[value='Smith']")));
